export class OseDice {
  ...
  static async sendRoll({
    ...
    const template = "systems/lotfp/templates/chat/roll-result.html";
  ...
  static async sendAttackRoll({
    ...
    const template = "systems/lotfp/templates/chat/roll-attack.html";
  ...
  static async RollSave({
    ...
    let rolled = false;
    const template = "systems/lotfp/templates/chat/roll-dialog.html";
    let dialogData = {
      formula: parts.join(" "),
      data: data,
