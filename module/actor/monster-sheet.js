...
export class OseActorSheetMonster extends OseActorSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      template: "systems/lotfp/templates/actors/monster-sheet.html",
      width: 450,
      height: 560,
      resizable: true,
      tabs: [
  ...
  async generateSave() {
    ...
    let templateData = { choices: choices },
      dlg = await renderTemplate(
        "/systems/lotfp/templates/actors/dialogs/monster-saves.html",
        templateData
      );
  ...
  async _chooseItemType(choices = ["weapon", "armor", "shield", "gear"]) {
    let templateData = { types: choices },
      dlg = await renderTemplate(
        "systems/lotfp/templates/items/entity-create.html",
        templateData
      );
    //Create Dialog window
